        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        EditText editItem = (EditText) dialogView.findViewById(R.id.item);
                        ...
                        mListener.onDialogPositiveClick(AddItemDialogFragment.this,item,count,price);
                    }
                })
